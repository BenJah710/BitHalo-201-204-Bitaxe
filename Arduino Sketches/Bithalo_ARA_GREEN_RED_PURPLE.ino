// v2.710 - Written by IamGPIO - BitHalo for the Bitaxe Modified by BenJah so accepted shares flash green, rejected shares flash red and abandoning work flashes purple.
#include <FastLED.h>
...
void processInput() {
  ...
  if (inputString.indexOf("abandoning") >= 0) {
    abandoning();
  }
